...
%global pkg_name webots_ros2_crazyflie
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-webots-ros2-crazyflie
Version:        2025.0.1
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Kimberly McGuire (Bitcraze AB) <kimberly@bitcraze.io> - 2025.0.1-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Kimberly McGuire (Bitcraze AB) <kimberly@bitcraze.io> - 2025.0.1-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Kimberly McGuire (Bitcraze AB) <kimberly@bitcraze.io> - 2025.0.1-1
- Autogenerated by Bloom
